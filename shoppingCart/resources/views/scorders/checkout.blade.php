...
type="text" name="productid[]" readonly value="{{ $product->id }}"></td>
...
<td> 
<input size="3" style="border:none"
class="qty" type="text" name="quantity[]" readonly value="{{ $lineitem['qty'] }}"> 
</td>
...
<button type="button" class="btn btn-default remove" onClick="$(this).closest('tr').remove();">
