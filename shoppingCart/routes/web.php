...
Route::get('scorders/checkout', [App\Http\Controllers\scorderController::class, 'checkout'])->name('scorders.checkout');
Route::post('scorders/placeorder', [App\Http\Controllers\scorderController::class, 'placeorder'])->name('scorders.placeorder');
